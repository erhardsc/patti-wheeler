	...
	public function row_styling_fields($fields){
		...
		$props = array(
			...
			array(
					...
					'wrap_with_class' => 'tf-group-element tf-group-element-image tf-group-element-video responsive-na',
			),
			// Background Zoom
			array(
					'id' => 'background_zoom',
	...
	public function subrow_styling_fields($fields){
		...
		$props = array(
			...
			array(
				...
				'label' => __('Background Color', 'themify'),
				'class' => 'small',
				'wrap_with_class' => 'tf-group-element tf-group-element-image tf-group-element-video tf-group-element-slider tf-group-element-video',
				'prop' => 'background-color',
				'selector' => '.module_subrow',
			),
			// Overlay Color
