...
d;if(!a||c.isValidate(f("#tb_module_settings",top_iframe))){f("body").trigger("themify_builder_save_component");b.saving=!0;var g={},e=null,k=!1,h=!1,l=null,n=null,t=!1,m="styling",w=f(".tb_element_cid_"+b.activeModel.cid);if(a||"row"===d)a&&(m="mod_settings",k=b.activeModel.get("is_new"),b.activeModel.unset("is_new",{silent:!0})),n=c.serialize("themify_builder_options_setting"),e=c.serialize("themify_builder_options_animation"),l=c.serialize("themify_builder_options_visibility"),"visual"===b.mode&&
("hide_all"===l.visibility_all||"hide"===l.visibility_desktop||"hide"===l.visibility_tablet||"hide"===l.visibility_mobile?w.addClass("tb_visibility_hidden"):w.removeClass("tb_visibility_hidden"));"visual"===b.mode&&b.liveStylingInstance.remember(b.activeModel.cid);ThemifyBuilderCommon.Lightbox.close();var c=f.extend(!0,{},b.Mixins.Common.styleData),d=f.extend(!0,{},b.activeModel.get(m)),u=c.breakpoint_desktop;delete c.breakpoint_desktop;for(var p in c)u[p]=c[p];g[m]=f.extend(!0,u,n,e,l);g[m]=b.Utils.clear(g[m]);
b.activeModel.set(g,{silent:!0});a&&(k&&(h=ThemifyBuilderCommon.Lightbox.clone(w.closest(".module_column")),b.Mixins.Builder.initGridMenu(w[0])),b.vent.trigger("dom:builder:change"),f(".tb-import-layout-button").remove());if("visual"===b.mode){var B=b.liveStylingInstance.getRememberedStyles();void 0===b.isComponentSaved[b.activeModel.cid]&&(b.isComponentSaved[b.activeModel.cid]=1,t=!0)}b.vent.trigger("dom:change",b.activeModel.cid,b.beforeEvent,w,"save",{old:d,"new":g[m],styles:B,column:h,first:t});
b.beforeEvent=!1;b.saving=!1}},moduleOptAddRow:function(a,c){a.preventDefault();var d=f(a.currentTarget).parent().prev(),g=b.cache.repeaterElements[d.prop("id")].clone(),e=Math.random().toString(36).substr(2,7),k=[],h=!1,l=!1,n=!a.isTrigger||c;g.removeClass("collapsed").find(".row_inner").show();var t=g[0].getElementsByClassName("tb_lb_option_child");c=c?f(c):!1;for(var m=0,w=t.length;m<w;++m){var u=f(t[m]);var p=c?c.find('[data-input-id="'+u.data("input-id")+'"]'):!1;var B=t[m].classList;if(B.contains("tb_lb_wp_editor")){var x=
u.data("input-id");var r=u.data("control-repeater");var q=u.closest(".wp-editor-wrap");u=x+"_"+m+"_"+Math.random().toString(36).substr(2,7);!1===h&&(h=q.html());q.html(h.replace(new RegExp(x,"g"),u));u=q.find(".tb_lb_wp_editor");u.attr({name:x,"data-input-id":x,"data-control-repeater":r}).data({"input-id":x,"control-repeater":r});p?(p=p.prop("id"),q=tinyMCE.get(p),p=!1===q.hidden?q.getContent():switchEditors.wpautop(tinymce.DOM.get(p).value),u.val(p)):u.val("");k.push(u)}else if(B.contains("themify-layout-icon"))q=
u.find("a"),q.removeClass("selected"),p?q.filter("#"+p.find(".selected").prop("id")).addClass("selected"):(p=themifyBuilder.modules[b.activeModel.get("mod_name")],void 0!==p&&void 0!==p.defaults&&p.defaults[x]?q.filter("#"+p.defaults[x]).addClass("selected"):q.first().addClass("selected"));else if(B.contains("themify-builder-uploader-input"))n&&(l=!0,p=!1!==p?p.val():"",q=u.val(p).parent(),r=q.find(".thumb_preview").find(".img-placeholder"),q.find(".tb-upload-btn").prop("id","pluploader_"+e+"_"+m+
"themify-builder-plupload-upload-ui").addClass("plupload-clone").find(".builder_button").prop("id","pluploader_"+e+"_"+m+"themify-builder-plupload-browse-button"),""!==p&&(p=f("<img/>",{src:p,width:50,height:50}),r.html(p)));else if(B.contains("tb-radio-input-container")){q=t[m].getElementsByClassName("themify-builder-radio-dnd");r=u.data("input-id");var A=p?p.find(":checked").val():!1;p=0;for(var z=q.length;p<z;++p){var C=f(q[p]);C.prop({name:r+"_"+e,id:r+"_"+e+"_"+p,checked:!1}).next("label").prop("for",
r+"_"+e+"_"+p);(A===C.val()||!A&&C.data("checked"))&&C.prop("checked",!0)}B.contains("tb-option-radio-enable")&&ThemifyBuilderCommon.Lightbox.clickRadioOption(null,u.find(":checked"))}else A=p?p.val():"",void 0===A&&(A=""),u.val(A);n&&(u.data("binding")&&b.Mixins.Common.doTheBinding(u,A,g),!B.contains("tb_lb_wp_editor")&&u.data("control-binding")&&u.data("control-type")&&b.Views.init_control(u.data("control-type"),{el:u,binding_type:u.data("control-binding")}))}n&&setTimeout(function(){b.Utils.setColorPicker(g)},
1);d[0].appendChild(g[0]);n&&(0<k.length&&setTimeout(function(){for(var a=0,c=k.length;a<c;++a)b.Views.init_control("wp_editor",{el:k[a],binding_type:k[a].data("control-binding")});k=null},1),l&&b.Utils.builderPlupload("new_elemn"))},builderImportSubmit:function(a){a.preventDefault();var c=f(this);ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.dialog_import_page_post,function(a){f.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",nonce:themifyBuilder.tb_load_nonce,
data:c.closest("form").serialize(),importType:"no"===a?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){b.Forms.reLoad(a,themifyBuilder.post_ID);ThemifyBuilderCommon.Lightbox.close()}})},{buttons:{no:{label:"Replace Existing Builder"},yes:{label:"Append Existing Builder"}}})},lightbox_switcher:function(a){a.preventDefault();a=f(a.currentTarget).attr("href").replace("#","");b.activeModel&&"visual"===b.mode&&(b.scrollTo=
b.liveStylingInstance.$liveStyledElmt);f(".tb_breakpoint_switcher.breakpoint-"+a,top_iframe).trigger("click")},reLoad:function(a,c){function d(){"visual"===b.mode&&(b.Utils.loadContentJs(),b.id=!1);b.vent.trigger("dom:builder:init");ThemifyBuilderCommon.showLoader("hide");"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(f("body",top_iframe).height(document.body.scrollHeight),setTimeout(function(){f("body",top_iframe).height(document.body.scrollHeight)},2E3))}b.Models.Registry.destroy();b.Instances.Builder=
{};var g="";if("visual"===b.mode){var e="themify-builder-"+c+"-generated-css",k=f("link#"+e),g="#themify_builder_content-"+c;b.id=c;k.remove();void 0!==a.css&&void 0!==a.css.css_file&&(e="<link id="+e+' type="text/css" rel="stylesheet" href="'+a.css.css_file+"?tmp="+Date.now()+'" />',document.getElementById("themify-builder-admin-ui-css").insertAdjacentHTML("afterend",e));b.VisualCache=[];b.editing=!1;b.isComponentSaved=[];setTimeout(function(){b.liveStylingInstance.reset()},1);f("body").addClass("sidebar-none full_width")}else g=
"#themify_builder_row_wrapper";b.Instances.Builder[0]=new b.Views.Builder({el:g,collection:new b.Collections.Rows(a.builder_data),type:"visual"});b.Instances.Builder[0].render();b.toolbar.undoManager.reset();"visual"===b.mode?b.bootstrap(null,d):d()},templateSelected:function(a){a.preventDefault();a.stopPropagation();var c=f(this).closest(".layout_preview");ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,function(a){var d=themifyBuilder.post_ID,e={type:"POST",
url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_set_layout",mode:"no"===a?1:0,nonce:themifyBuilder.tb_load_nonce,layout_slug:c.data("slug"),id:d,layout_group:c.data("group")},beforeSend:function(){"visual"===b.mode&&ThemifyBuilderCommon.showLoader("show")},success:function(a){ThemifyBuilderCommon.Lightbox.close();"success"===a.status?b.Forms.reLoad(a,d):(ThemifyBuilderCommon.showLoader("error"),alert(a.msg))}};if("pre-designed"===c.data("group")){ThemifyBuilderCommon.showLoader("show");
var k=c.data("slug"),h="https://themify.me/themify-layouts/"+k+".txt",l=function(){e.data.builder_data=b.layouts_selected[k];f.ajax(e)};if(!b.layouts_selected)b.layouts_selected={};else if(b.layouts_selected[k]){l();return}f.get(h,null,null,"text").done(function(a){b.layouts_selected[k]=a;l()}).fail(function(a,c,b){ThemifyBuilderCommon.LiteLightbox.alert("There was an error in loading layout, please try again later, or you can download this file: ("+h+") and then import manually (http://themify.me/docs/builder#import-export).")}).always(function(){ThemifyBuilderCommon.showLoader()})}else f.ajax(e)},
{buttons:{no:{label:"Replace Existing Layout"},yes:{label:"Append Existing Layout"}}})},saveAsLayout:function(a){a.preventDefault();f.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_save_custom_layout",nonce:themifyBuilder.tb_load_nonce,form_data:f("#tb_save_layout_form",top_iframe).serialize()},success:function(a){"success"===a.status?ThemifyBuilderCommon.Lightbox.close():alert(a.msg)}})},widget_actions:function(){var a={},c=!1,d=!1,g=!1;f("body",top_iframe).on("change",
"#class_widget",function(){var e=f(this).val(),k=f(this).find(" :selected").data("idbase"),h=c["widget-id"],l=function(k,h){var l=f("#instance_widget",top_iframe),n=f(h.form),u=function(a){"text"===a?d||(d=!0,wp.textWidgets.init()):g||(wp.mediaWidgets.init(),g=!0);f(document).trigger("widget-added",[l]);"text"===a&&b.Views.init_control("wp_editor",{el:l.find(".wp-editor-area"),binding_type:"refresh"})},p=function(a,c,b){var d=a.length;(function(a,c,b){Themify.LoadAsync(a,c,null,null,b)})(a[c],function(){++c;
c<d?p(a,c,b):u(b)})};if(c)for(var t in c)n.find('[name="'+t+'"]').val(c[t]);n.find(".widget-id").val(Math.random());n.find("select").wrap('<span class="selectwrapper"/>');l.html(n.html());void 0===a[k]&&h.template?(document.getElementsByTagName("body")[0].insertAdjacentHTML("beforeend",h.template),0<h.src.length&&p(h.src,0,k)):h.init&&u(k,h.form);"visual"===b.mode&&e&&l.find(":input").first().trigger("change")};q.class_widget=e;void 0!==a[k]&&h===a[k].widgetID?l(k,a[k]):f.ajax({type:"POST",dataType:"json",
url:themifyBuilder.ajaxurl,data:{action:"module_widget_get_form",tb_load_nonce:themifyBuilder.tb_load_nonce,load_class:e,tpl_loaded:+(0<f("#tmpl-media-modal").length),id_base:k,widget_instance:c},success:function(c){c&&c.form&&(l(k,c),a[k]={form:c.form,init:0<c.src.length,widgetID:h})}})});f("body").on("editing_module_option",function(a,b,d,g){"widget"===b&&d.instance_widget&&(c=d.instance_widget,setTimeout(function(){f("#class_widget",g).trigger("change");c=!1},200))})},isValidate:function(a){var c=
a.find("[data-validation]");if(0===c.length)return!0;var b=this,g={};c.each(function(){var a=f(this),c=a.data("validation"),d=a.val();b.checkValidate(c,d)||(g[a.prop("id")]=a.data("error-msg"))});a.find(".tb_field_error").removeClass("tb_field_error").end().find(".tb_field_error_msg").remove();if(_.isEmpty(g))return!0;var e=0;_.each(g,function(c,b){var d=a.find("#"+b);d.addClass("tb_field_error");f("<span/>",{"class":"tb_field_error_msg","data-error-key":b}).text(c).insertAfter(d);e||(d=a.children().index(d.closest(".themify_builder_options_tab_wrapper")),
(d=-1<d&&a.closest("#themify_builder_lightbox_parent").find(".themify_builder_options_tab > li").eq(d))&&!d.hasClass("current")&&d.trigger("click"),e++)});return!1},checkValidate:function(a,c){return b.Forms.get_validator(a)(c)},clear:function(){if(b.activeModel&&(void 0!==b.activeModel.get("is_new")&&b.activeModel.trigger("dom:module:unsaved"),b.activeModel=null,void 0!==tinyMCE))for(var a=tinymce.editors.length-1;-1<a;a--)"content"!==tinymce.editors[a].id&&tinyMCE.execCommand("mceRemoveEditor",
!0,tinymce.editors[a].id)}};b.Forms.register_validator=function(a,c){this.Validators[a]=c};b.Forms.get_validator=function(a){return void 0!==this.Validators[a]?this.Validators[a]:this.Validators.not_empty};b.Forms.register_validator("email",function(a){var c=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;a=a.split(",");return!(0<f.map(a,function(a,b){return c.test(a)?null:"1"}).length)});b.Forms.register_validator("not_empty",
function(a){return!(!a||""===a.trim())});b.Views.Toolbar=Backbone.View.extend({events:{"click .tb_import":"import","click .themify_builder_load_layout":"loadLayout","click .themify_builder_save_layout":"saveLayout","click .themify_builder_dup_link":"duplicate","click .tb_toolbar_save":"save","click .tb_toolbar_backend_edit a":"save","click .tb_toolbar_close_btn":"panelClose","click .tb_breakpoint_switcher":"breakpointSwitcher","click .themify_builder_zoom":"zoom","click .tb_toolbar_zoom_menu_toggle":"zoom",
"click .tb_toolbar_builder_preview":"previewBuilder"},initialize:function(){var a=[],c=this,d=this.$el.find(".tb_module_panel_modules_wrap"),g=wp.template("builder_module_item_draggable"),e;for(e in themifyBuilder.modules)a.push(g({slug:e,name:themifyBuilder.modules[e].name,type:themifyBuilder.modules[e].type?themifyBuilder.modules[e].type:"",favorite:+themifyBuilder.modules[e].favorite}));d[0].innerHTML=a.join("")+'<span class="favorite-separator"></span>';f("#tmpl-builder_module_item_draggable").remove();
"visual"===b.mode&&f("body",top_iframe)[0].appendChild(this.el);a=null;setTimeout(function(){c.Panel.init();c.undoManager.init();"visual"===b.mode?(window.top.jQuery("body").one("themify_builder_ready",function(a){new SimpleBar(d[0])}),c.unload()):new SimpleBar(d[0]);c.preDesignedRows.init()},1);setTimeout(function(){c.Revisions.init()},800);f("body",top_iframe).on("click",".themify_module_favorite",c.toggleFavoriteModule);if("visual"===b.mode)f("body").on("click",".themify_module_favorite",c.toggleFavoriteModule)},
"import":function(a){a.preventDefault();a=ThemifyBuilderCommon.detectBuilderComponent(f(a.currentTarget));var c=null,d={dataType:"html",data:{action:"builder_import",type:a}};if("file"!==a||confirm(themifyBuilder.i18n.importFileConfirm))"file"===a&&(c=function(){b.Utils.builderPlupload("",!0)}),ThemifyBuilderCommon.Lightbox.open(d,null,c)},unload:function(){var a=this;"visual"===b.mode&&document.getElementsByTagName("head")[0].insertAdjacentHTML("afterbegin",'<base target="_parent">');window.top.onbeforeunload=
function(){return!b.editing&&a.undoManager.hasUndo()?"Are you sure":null}},panelClose:function(a){a.preventDefault();window.parent.location.reload(!0)},undoManager:{stack:[],is_working:!1,index:-1,btnUndo:document.getElementsByClassName("tb-undo-btn")[0],btnRedo:document.getElementsByClassName("tb-redo-btn")[0],init:function(){var a=this;b.toolbar.$el.find(".tb-undo-redo").on("click",this.do_change.bind(this));if(!themifyBuilder.disableShortcuts&&(f(top_iframe).on("keydown",this.keypres.bind(this)),
"visual"===b.mode))f(document).on("keydown",this.keypres.bind(this));b.vent.on("dom:change",function(c,d,g,e,k){b.editing=!1;g&&(g=ThemifyBuilderCommon.Lightbox.clone(g));"visual"!==b.mode||"duplicate"!==e&&"sort"!==e||f(window).trigger("tfsmartresize.tfVideo");a.stack.splice(a.index+1,a.stack.length-a.index);a.stack.push({cid:c,type:e,data:k,before:d,after:g});a.index=a.stack.length-1;a.updateUndoBtns();"visual"===b.mode&&f("body").trigger("builder_dom_changed",[e])})},set:function(a){var c=a[0].querySelectorAll("[data-cid]"),
c=Array.prototype.slice.call(c);c.unshift(a[0]);a=0;for(var d=c.length;a<d;++a){var g=b.Models.Registry.lookup(c[a].getAttribute("data-cid"));g&&g.trigger("change:view",c[a])}},doScroll:function(a){("visual"!==b.mode||"desktop"===b.activeBreakPoint?f("body"):f("body",top_iframe)).scrollTop(a.offset().top)},keypres:function(a){if(90===a.which&&"INPUT"!==document.activeElement.tagName&&"TEXTAREA"!==document.activeElement.tagName)if(!0===a.ctrlKey&&!0===a.shiftKey||!0===a.metaKey&&!0===a.shiftKey)a.preventDefault(),
this.hasRedo()&&this.changes(!1);else if(!0===a.ctrlKey||!0===a.metaKey)a.preventDefault(),this.hasUndo()&&this.changes(!0)},changes:function(a){var c=this.stack[this.index+(a?0:1)];if(void 0!==c){this.is_working=!0;var d="";var g=c.type,e=f(".tb_element_cid_"+c.cid);var k=!1;if("row"===g)a?(d=c.before.clone(!0),k=c.cid):(d=c.after.clone(!0),k=c.before.data("cid"),e=f(".tb_element_cid_"+k)),this.set(d),e.replaceWith(d);else if("duplicate"===g)a?f(".tb_element_cid_"+c.after.data("cid")).remove():(d=
c.after.clone(!0),k=c.before.data("cid"),this.set(d),e.after(d));else if("delete_row"===g)a?(d=c.before.clone(!0),k=c.cid,e=f(".tb_element_cid_"+c.data.pos_cid),this.set(d),"after"===c.data.pos?e.after(d):e.before(d)):e.remove();else if("sort"===g)k=c.cid,a?(e=c.data.after,g=c.data.before,d=c.before.clone(!0)):(e=c.data.before,g=c.data.after,d=c.after.clone(!0),"visual"===b.mode&&d.find(".active_module").css({display:"block",height:"auto"})),this.set(d),f(".tb_element_cid_"+e).find(".tb_element_cid_"+
k).remove(),f(".tb_element_cid_"+g).replaceWith(d);else if("save"===g){k=c.cid;var g=b.Models.Registry.lookup(k),h="module"===g.get("elType"),l={},n=h?"mod_settings":"styling";h&&c.data.column?a?(k=!1,e.remove()):(k=c.data.column.data("cid"),d=c.data.column.clone(!0),e=f(".tb_element_cid_"+k),this.set(d),e.replaceWith(d)):(a?(l[n]=c.data.old,d=c.before.clone(!0)):(l[n]=c.data["new"],d=c.after.clone(!0)),g.set(l,{silent:!0}),this.set(d),e.replaceWith(d),"visual"===b.mode&&b.liveStylingInstance.doUndo(c.data.styles,
a?c.data.first:!1))}else if("predesign"===g)if(e=c.data.rows,a)for(g=0,h=e.length;g<h;++g)f(".tb_element_cid_"+e[g].data("cid")).remove();else{l=document.createDocumentFragment();d=[];g=0;for(h=e.length;g<h;++g)n=ThemifyBuilderCommon.Lightbox.clone(e[g]),l.appendChild(n[0]),d.push(n);!1!==c.data.prev?f(".tb_element_cid_"+c.data.prev).after(l):f("#themify_builder_content-"+c.data.bid).prepend(l);g=0;for(h=d.length;g<h;++g)this.set(d[g]),b.Mixins.Builder.update(d[g])}else if("import"===g){var e=f('[data-postid="'+
c.data.bid+'"]'),c=a?c.data.before.clone(!0):c.data.after.clone(!0),t=this;e.children().remove();e.prepend(c);c.each(function(){t.set(f(this))})}k&&b.Mixins.Builder.update(d);a?this.index--:this.index++;this.is_working=!1;this.updateUndoBtns()}},hasRedo:function(){return this.index<this.stack.length-1},hasUndo:function(){return-1!==this.index},disable:function(){this.btnUndo.classList.add("tb_disabled");this.btnRedo.classList.add("tb_disabled")},updateUndoBtns:function(){this.hasUndo()?this.btnUndo.classList.remove("tb_disabled"):
this.btnUndo.classList.add("tb_disabled");this.hasRedo()?this.btnRedo.classList.remove("tb_disabled"):this.btnRedo.classList.add("tb_disabled")},reset:function(){this.stack=[];this.index=-1;this.updateUndoBtns()},do_change:function(a){a.preventDefault();!1===this.is_working&&-1===a.currentTarget.className.indexOf("tb_disabled")&&this.changes(-1!==a.currentTarget.className.indexOf("tb-undo-btn"))}},loadLayout:function(a){function c(a){a.each(function(a){0===a%4?f(this).addClass("layout-column-break"):
f(this).removeClass("layout-column-break")})}a.preventDefault();var b=this;ThemifyBuilderCommon.Lightbox.open(b.layouts_list?{loadMethod:"html",data:b.layouts_list}:{data:{action:"tb_load_layout"}},null,function(a){function d(){var a=g.find(".layout_preview_list");h.show().find("a").on("click",function(b){b.preventDefault();f(this).hasClass("selected")||(b=a,f(this).hasClass("all")||(a.hide(),b=a.filter('[data-category*="'+f(this).text()+'"]')),b.show(),c(b),h.find("a").removeClass("selected"),f(this).addClass("selected"),
h.parent().find(".tb_filter_layouts").html(f(this).text()))});g.find("#themify_builder_layout_search").on("keyup",function(){var b=f.trim(f(this).val()),d=a;""!==b&&(d=h.find("a.all"),d.hasClass("selected")||d.click(),a.hide(),d=a.find(".layout_title:contains("+b+")").closest(".layout_preview_list"));d.show();c(d)})}a=f(a);var g=a.find("#themify_builder_tabs_pre-designed"),h=g.find("#themify_builder_pre-designed-filter");0!=g.length&&(b.layouts_list?d():(ThemifyBuilderCommon.showLoader("show"),f.getJSON("https://themify.me/themify-layouts/index.json").done(function(e){var k=
window.top.wp.template("themify-builder-layout-item"),l={},m="";e=f(k(e));e.find("li").each(function(){for(var a=f(this).data("category").split(","),c=0,b=a.length;c<b;++c)""!==a[c]&&void 0===l[a[c]]&&(m+='<li><a href="#">'+a[c]+"</a></li>",l[a[c]]=1)});l=null;h[0].insertAdjacentHTML("beforeend",m);g[0].insertAdjacentHTML("beforeend",e[0].outerHTML);a.find(".themify_builder_tab").each(function(){c(f(this).find(".layout_preview_list"))});b.layouts_list=a[0];d();new SimpleBar(a[0])}).fail(function(a,
c,b){ThemifyBuilderCommon.LiteLightbox.alert(f("#themify_builder_load_layout_error",g).show().text())}).always(function(){ThemifyBuilderCommon.showLoader("spinhide")})))})},saveLayout:function(a){a.preventDefault();ThemifyBuilderCommon.Lightbox.open({data:{action:"tb_custom_layout_form",postid:themifyBuilder.post_ID}},function(){b.Utils.builderPlupload("normal")})},duplicate:function(a){function c(){d.Revisions.ajax({action:"tb_duplicate_page",tb_is_admin:"visual"!==b.mode},function(a){a&&(window.top.location.href=
f("<div/>").html(a).text())})}a.preventDefault();var d=this;confirm(themifyBuilder.i18n.confirm_on_duplicate_page)?b.Utils.saveBuilder(c):c()},Revisions:{init:function(){b.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this));f("body",top_iframe).on("click",".js-builder-restore-revision-btn",this.restore.bind(this)).on("click",".js-builder-delete-revision-btn",this["delete"].bind(this))},revision:function(a){a.preventDefault();a.currentTarget.classList.contains("tb_save_revision")?
this.save():this.load()},load:function(){ThemifyBuilderCommon.Lightbox.open({data:{action:"tb_load_revision_lists",postid:themifyBuilder.post_ID,tb_load_nonce:themifyBuilder.tb_load_nonce}})},ajax:function(a,c){a=f.extend({},a,{tb_load_nonce:themifyBuilder.tb_load_nonce,postid:themifyBuilder.post_ID});return f.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:a,beforeSend:function(){ThemifyBuilderCommon.showLoader("show")},complete:function(){ThemifyBuilderCommon.showLoader("hide")},success:function(a){f.isFunction(c)&&
c.call(this,a)}})},save:function(a){var c=this;ThemifyBuilderCommon.LiteLightbox.prompt(themifyBuilder.i18n.enterRevComment,function(d){null!==d&&b.Utils.saveBuilder(function(){c.ajax({action:"tb_save_revision",rev_comment:d},a)},"main",0,!0)})},restore:function(a){a.preventDefault();var c=f(a.currentTarget).data("rev-id"),d=this,g=function(){d.ajax({action:"tb_restore_revision_page",revid:c},function(a){a.status?(b.Forms.reLoad(a,themifyBuilder.post_ID),ThemifyBuilderCommon.Lightbox.close()):(ThemifyBuilderCommon.showLoader("error"),
alert(a.data))})};ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.confirmRestoreRev,function(a){"yes"===a?d.save(g):g()},{buttons:{no:{label:"Don't Save"},yes:{label:"Save"}}})},"delete":function(a){a.preventDefault();if(confirm(themifyBuilder.i18n.confirmDeleteRev)){var c=f(a.currentTarget);a=c.data("rev-id");this.ajax({action:"tb_delete_revision",revid:a},function(a){a.success?c.closest("li").remove():(ThemifyBuilderCommon.showLoader("error"),alert(a.data))})}}},save:function(a){a.preventDefault();
a.stopPropagation();var c=0<f(a.currentTarget).closest(".tb_toolbar_backend_edit").length?f(a.currentTarget).prop("href"):!1;b.Utils.saveBuilder(function(a,g){"success"!==g?alert(themifyBuilder.i18n.errorSaveBuilder):!1!==c&&("visual"===b.mode?(sessionStorage.setItem("focusBackendEditor",!0),window.top.location.href=c):(b.toolbar.undoManager.reset(),b._backendSwitchFrontend()))})},preDesignedRows:{is_init:null,rows:[],btn:null,filter_toolbar:null,filter_btn:null,clicked:null,init:function(){this.btn=
f('<div class="tb_modules_panel_wrap" id="tb_plus_btn_popover"></div>');f("body").append(this.btn);setTimeout(function(){document.getElementsByTagName("head")[0].insertAdjacentHTML("afterbegin",'<meta http-equiv="x-dns-prefetch-control" content="on"/><link href="//themify.me" rel="dns-prefetch preconnect"/><link href="//fonts.googleapis.com" rel="dns-prefetch"/><link href="//maps.google.com" rel="dns-prefetch"/><link href="https://themify.me/public-api/predesigned-rows/index.json" rel="prefetch"/>')},
7E3);var a=this;this.btn.on("click",".add_module_btn",function(c){b.toolbar.Panel.add_module(c,a.clicked.closest(".module_row").find(".themify_module_holder").last());a.clicked=null;a.btn.hide()}).on("keyup",".tb_module_panel_search_text",this.search.bind(this));if("visual"===b.mode)b.toolbar.$el.find(".tb_module_types a").on("click",this.tabs.bind(this));b.toolbar.$el.find(".tb_module_panel_search_text").on("keyup",this.search.bind(this));f("body").on("click",".tb_module_types a",this.tabs.bind(this)).on("click",
".tb_row_btn_plus",this.show.bind(this));f(document).on("tb_setpredesignedrows",this.get.bind(this))},load:function(a,c){if(null===this.is_init){this.is_init=!0;var d=this;a.addClass("tb_busy");f.getJSON("https://themify.me/public-api/predesigned-rows/index.json").done(function(b){d.setData(b,a,c)}).fail(function(a,c,d){this.is_init=null;ThemifyBuilderCommon.showLoader("error");b.toolbar.$el.find(".tb_predesigned_rows_list").html("<h3>Failed to load Pre-Designed Rows from server.</h3>")})}},setData:function(a,
c,d){for(var g=[],e="",f="",h=0,l=a.length;h<l;++h){for(var n=a[h].category.split(","),t="",m=0,w=n.length;m<w;++m)-1===g.indexOf(n[m])&&g.push(n[m]),t+=" tb"+Themify.hash(n[m]);if(void 0===a[h].thumbnail||""===a[h].thumbnail)a[h].thumbnail="https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(a[h].title)+"&w=181&h=77";f+='<div class="predesigned_row'+t+'" data-slug="'+a[h].slug+'"><figure class="tb_predesigned_rows_list_image">';f+='<img alt="'+a[h].title+'" title="'+a[h].title+'" src="'+
a[h].thumbnail+'" /></figure>';f+='<div class="tb_predesigned_rows_list_title">'+a[h].title+"</div></div>"}a=null;g.sort();h=0;for(l=g.length;h<l;++h)e+='<li><a href="#" data-slug="'+Themify.hash(g[h])+'">'+g[h]+"</li>";b.toolbar.$el.find(".tb_row_filter")[0].insertAdjacentHTML("beforeend",e);var u=b.toolbar.$el.find(".tb_predesigned_rows_list");u[0].insertAdjacentHTML("beforeend",f);this.btn[0].insertAdjacentHTML("beforeend",b.toolbar.$el.find("#tb_module_panel")[0].innerHTML);this.btn.find(".tb_module_panel_lock").remove();
this.btn.find(".themify_builder_module_outer").show();this.btn.find(".tb_module_panel_search_text").val("");var p=this;u.find("img").last().one("load",function(){p.filter();"visual"===b.mode?b.Mixins.Builder.initRowVisualDrag():b.Mixins.Builder.initRowDraggable(b.toolbar.$el);c.removeClass("tb_busy");new SimpleBar(u[0]);new SimpleBar(p.btn.find(".tb_module_panel_modules_wrap")[0]);new SimpleBar(p.btn.find(".tb_predesigned_rows_list")[0]);b.Mixins.Builder.initModuleDraggable(p.btn);b.Mixins.Builder.initRowDraggable(p.btn);
"function"===typeof d&&d()})},get:function(a,c,b){ThemifyBuilderCommon.showLoader("show");if(void 0!==this.rows[c])"function"===typeof b&&b(this.rows[c]);else{var d=this;f.getJSON("https://themify.me/public-api/predesigned-rows/"+c+".txt").done(function(a){d.rows[c]=a;"function"===typeof b&&b(a)}).fail(function(a,c,b){ThemifyBuilderCommon.showLoader("error");alert("Failed to fetch row template")})}},tabs:function(a){a.preventDefault();a.stopPropagation();a=f(a.currentTarget);var c=a.data("target"),
b=a.closest(".tb_modules_panel_wrap");null===this.is_init&&this.load(b);b.find("."+c).show().siblings(".tb_module_panel_tab").hide();a.closest("li").addClass("active").siblings().removeClass("active");b.find(".tb_module_panel_search_text").val("")},show:function(a){function c(){"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(f("body",top_iframe).height(document.body.scrollHeight+d.btn.outerHeight(!0)),f("body").css("padding-bottom",180))}a.preventDefault();a.stopPropagation();var d=this;this.clicked=
f(a.currentTarget);a=this.clicked.offset();var g=b.toolbar.Panel.is_locked&&"visual"===b.mode?b.toolbar.$el.find("#tb_module_panel").outerWidth():0;this.btn.css({top:a.top,left:a.left-this.btn.width()/2+11-g}).show();null===this.is_init?this.load(this.btn,c):c();this.hide()},hide:function(){function a(d){c.btn.is(":hover")||(c.btn.hide(),c.clicked=null,f(document).off("click",a),f(top_iframe).off("click",a),"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(f("body",top_iframe).height(document.body.scrollHeight),
f("body").css("padding-bottom","")))}var c=this;if("visual"===b.mode)f(top_iframe).on("click",a);f(document).on("click",a)},search:function(a){a=f(a.currentTarget);var c=a.closest(".tb_modules_panel_wrap"),b="tb_module_panel_modules_wrap"===c.find(".tb_module_types .active a").data("target"),g=!b&&this.is_init?"tb_module_panel"===c.prop("id")?this.filter_toolbar:this.filter_btn:!1,c=b?c.find(".themify_builder_module_outer"):this.is_init?c.find(".predesigned_row"):!1;a=f.trim(a.val());if(!1!==c){var e=
""===a,k=e?!1:new RegExp(a,"i");c.each(function(){if(g&&!f(this).hasClass(g))return!0;var a=b?f(this).find(".module_name"):f(this).find(".tb_predesigned_rows_list_title");e||k.test(a.text())?f(this).show():f(this).hide()})}},filter:function(){function a(a){a.preventDefault();a.stopPropagation();a=f(a.currentTarget);var c=a.data("slug"),b=a.closest(".tb_modules_panel_wrap"),e=b.find(".tb_row_filter_active"),k=b.find(".predesigned_row");e.text(a.text());b.find(".tb_module_panel_search_text").val("");
if(c){var h="tb"+c;k.each(function(){f(this).hasClass(h)?f(this).show():f(this).hide()})}else k.show();"tb_module_panel"===b.prop("id")?this.filter_toolbar=h:this.filter_btn=h}b.toolbar.$el.find(".tb_row_filter").on("click","a",a.bind(this));this.btn.find(".tb_row_filter").on("click","a",a.bind(this))}},breakpointSwitcher:function(a){function c(){g.responsive_grids(e,h);"visual"===b.mode&&l.css("will-change","auto");k.toggleClass("tb_responsive_mode","desktop"!==e).removeClass("builder-breakpoint-"+
h).addClass("builder-breakpoint-"+e);f("body").trigger("themify_builder_change_mode",[h,e]);"visual"===b.mode?(b.Mixins.Builder.updateModuleSort(null,"desktop"===e?"enable":"disable"),b.Utils._onResize(!0,function(){g.iframeScroll("desktop"!==e);f("body",top_iframe).height("desktop"!==e?document.body.scrollHeight:"auto");b.scrollTo&&setTimeout(function(){f(window).add(top_iframe).scrollTop(b.scrollTo.offset().top);b.scrollTo=!1},500);setTimeout(function(){b.Utils.setCompactMode(document.getElementsByClassName("module_column"));
k.removeClass("tb_start_animate")},200)})):k.removeClass("tb_start_animate")}a.preventDefault();var d="",g=this,e="desktop";a=f(a.currentTarget);var k=f("body",top_iframe),h=b.activeBreakPoint;a.hasClass("breakpoint-tablet")?e="tablet":a.hasClass("breakpoint-tablet_landscape")?e="tablet_landscape":a.hasClass("breakpoint-mobile")&&(e="mobile");if(h===e)return!1;b.activeBreakPoint=e;"visual"===b.mode&&(k=k.add("body"));k.addClass("tb_start_animate");"desktop"!==e&&(d=b.Utils.getBPWidth(e)-1);if("visual"===
b.mode){var l=f("#themify_builder_site_canvas_iframe",top_iframe);f(".tb_toolbar_zoom_menu",top_iframe).removeClass("tb_toolbar_zoom_active").find(".tb_toolbar_zoom_menu_toggle").data("zoom",100);l.css("will-change","width").one(b.Utils.transitionPrefix(),c).css("width",d).parent().removeClass("themify_builder_zoom_bg")}else c()},iframeScroll:function(a){var c=f(top_iframe);c.off("scroll.themifybuilderresponsive");if(a)c.on("scroll.themifybuilderresponsive",function(){window.scrollTo(0,f(this).scrollTop())})},
responsive_grids:function(a,c){var b=document.querySelectorAll(".row_inner,.subrow_inner");"tablet_landscape"===a&&(a="tablet");for(var g="desktop"===a,e=g||"desktop"===c,k="tablet"===a?"mobile":"tablet",h=0,l=b.length;h<l;++h){var n=b[h].getAttribute("data-basecol");if(n){var t=b[h].children,m=b[h].dataset["col_"+a],w=t[0],u=t[t.length-1];if(!g){var p=b[h].getAttribute("data-col_"+k);b[h].classList.remove("tb_3col");p&&b[h].classList.remove(f.trim(p.replace("tb_3col","").replace("mobile","column").replace("tablet",
"column")));if(m&&"-auto"!==m){if(m=b[h].getAttribute("data-col_"+a)){b[h].classList.add("tb_grid_classes");b[h].classList.add("col-count-"+n);var m=m.split(" "),q;for(q in m)b[h].classList.add(f.trim(m[q].replace("mobile","column").replace("tablet","column")))}}else b[h].classList.remove("tb_grid_classes"),b[h].classList.remove("col-count-"+n)}if(e)for(n=0,m=t.length;n<m;++n)p=f(t[n]).data("w"),void 0!==p&&(t[n].style.width=g?p+"%":"");"rtl"===b[h].getAttribute("data-"+a+"_dir")?(w.classList.remove("first"),
w.classList.add("last"),u.classList.remove("last"),u.classList.add("first"),b[h].classList.add("direction-rtl")):(w.classList.remove("last"),w.classList.add("first"),u.classList.remove("first"),u.classList.add("last"),b[h].classList.remove("direction-rtl"))}}},Panel:{el:null,is_locked:!1,key:"tb_module_panel_locked",init:function(){this.el=b.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.blur().hover(this.toogle.bind(this)).find(".tb_module_panel_lock").on("click",this.lock.bind(this));
this._setupModulePanelState();this.el.find(".add_module_btn").on("click",this.add_module)},add_module:function(a,c){a.preventDefault();a.stopPropagation();c=c||b.Instances.Builder[0].$el.find(".module_row").last().find(".themify_module_holder").first();var d=c.offset().top-37;"visual"===b.mode?"desktop"!==b.activeBreakPoint&&f(top_iframe).scrollTop(d):d-=50;f(window).scrollTop(d);b.Mixins.Builder.moduleDrop(f(a.currentTarget).closest(".themify_builder_module"),c)},resetPanel:function(){this.el.removeClass("tb_disabled");
this.is_locked&&this.toggleLock()},toogle:function(a){this.is_locked||this.el.hasClass("tb_disabled")||f(a.currentTarget).focus()},lock:function(a){a.preventDefault();this.is_locked=!this.is_locked;localStorage.setItem(this.key,this.is_locked);this.toggleLock();if(!this.is_locked){this.el.addClass("tb_hide_panel");var c=this;setTimeout(function(){b.toolbar.$el.find("#themify_builder_switch_backend").focus();c.el.removeClass("tb_hide_panel")},1E3)}},toggleLock:function(){var a=b.toolbar.$el;"visual"===
b.mode&&(a=a.add(f("body")),a.addClass("tb_remove_transitions"));f("body",top_iframe).toggleClass("tb_module_panel_locked");f(window).trigger("tfsmartresize");a.removeClass("tb_remove_transitions")},_setupModulePanelState:function(){this.is_locked=localStorage.getItem(this.key);"false"===this.is_locked&&(this.is_locked=!1);if(this.is_locked){var a=this;setTimeout(function(){a.toggleLock()},1200)}},hide:function(){this.el.blur();this.resetPanel();this.el.addClass("tb_disabled")},show:function(){this.is_locked||
this.el.focus()}},toggleFavoriteModule:function(){var a=f(this),c=a.closest(".themify_builder_module_outer"),d=a.parent().data("module-slug");f.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_module_favorite",module_name:d,module_state:+!c.hasClass("favorited")},beforeSend:function(a){function e(a,c){function k(){a.removeAttr("style");if(c){var g=0<a.closest("#tb_plus_btn_popover").length?b.toolbar.$el:f("#tb_plus_btn_popover");e(g.find(".module-type-"+d).closest(".themify_builder_module_outer"),
!1)}}if(a.is(":visible"))a.css({opacity:0,transform:"scale(0.5)"}).one(g,function(){a.toggleClass("favorited").css({opacity:1,transform:"scale(1)"}).one(g,k)});else a.toggleClass("favorited"),k()}var g=b.Utils.transitionPrefix();e(c,!0)}})},zoom:function(a){a.preventDefault();if("desktop"!==b.activeBreakPoint)return!0;var c=f(a.currentTarget);a=c.data("zoom");var d=f(".themify_builder_site_canvas_iframe",top_iframe),g=c.closest(".tb_toolbar_zoom_menu");c.hasClass("tb_toolbar_zoom_menu_toggle")?(a=
"100"==a?50:100,c.data("zoom",a),c=c.next("ul").find('[data-zoom="'+a+'"]')):g.find(".tb_toolbar_zoom_menu_toggle").data("zoom",a);d.removeClass("themify_builder_zooming_50 themify_builder_zooming_75");c.parent().addClass("selected-zoom-size").siblings().removeClass("selected-zoom-size");"50"==a||"75"==a?(c="50"==a?2:1.25,d.addClass("themify_builder_zooming_"+a).parent().addClass("themify_builder_zoom_bg").css("height",Math.max(window.top.innerHeight*c,600)),g.addClass("tb_toolbar_zoom_active"),b.zoomMeta.isActive=
!0,b.zoomMeta.size=a,f("body").addClass("tb-zoom-only")):(d.addClass("themify_builder_zooming_"+a).parent().css("height",""),g.removeClass("tb_toolbar_zoom_active"),b.zoomMeta.isActive=!1,f("body").removeClass("tb-zoom-only"))},previewBuilder:function(a){a.preventDefault();f(a.currentTarget).toggleClass("tb_toolbar_preview_active");b.isPreview=!b.isPreview;f("body").toggleClass("tb-preview-only themify_builder_active");f("body",top_iframe).toggleClass("tb-preview-parent");b.isPreview?this.Panel.hide():
this.Panel.resetPanel();(function(){b.isPreview?f(".col-count-1.row_inner").each(function(){if(0===this.getElementsByClassName("active_module").length){var a=this.getElementsByClassName("module_column")[0];if((a=b.Models.Registry.lookup(a.dataset.cid))&&0===Object.keys(a.get("styling")).length){var a=f(this).closest(".module_row"),d=b.Models.Registry.lookup(a.data("cid"));d&&0===Object.keys(d.get("styling")).length&&a.addClass("tb-hide")}}}):f(".tb-hide.module_row").removeClass("tb-hide")})();b.vent.trigger("dom:preview")}});
b.Views.bindEvents=function(){ThemifyBuilderCommon.Lightbox.setup();ThemifyBuilderCommon.LiteLightbox.modal.on("attach",function(){this.$el.addClass("themify_builder_lite_lightbox_modal")});b.Utils.mediaUploader();b.Utils.openGallery()};b.Utils={onResizeEvents:[],gridClass:"col-full col4-1 col4-2 col4-3 col3-1 col3-2 col6-1 col5-1".split(" "),_onResize:function(a,c){var d=f._data(window,"events").resize;if(""===tbLocalScript.fullwidth_support)f(window.top).off("tfsmartresize.tb_visual").on("tfsmartresize.tb_visual",
function(a){f(window).trigger("tfsmartresize.tbfullwidth").trigger("tfsmartresize.tfVideo")});f(window.top).off("tfsmartresize.zoom").on("tfsmartresize.zoom",function(){if(b.zoomMeta.isActive){var a="50"==b.zoomMeta.size?2:1.25;f(".themify_builder_workspace_container",top_iframe).css("height",Math.max(window.top.innerHeight*a,600))}});if(void 0!==d)for(var g=0,e=d.length;g<e;++g)void 0!==d[g].handler&&this.onResizeEvents.push(d[g].handler);f(window).off("resize");if(a){d=f.Event("resize",{type:"resize",
isTrigger:!1});g=0;for(e=this.onResizeEvents.length;g<e;++g)try{this.onResizeEvents[g].apply(window,[d,f])}catch(k){}"function"===typeof c&&c()}},_addNewColumn:function(a,c){var d=b.Views.init_column({grid_class:a.newclass,component_name:a.component},a.type);c.append(d.view.render().$el)},filterClass:function(a){a=a.split(" ");for(var c=[],b=0,f=a.length;b<f;++b)-1!==this.gridClass.indexOf(a[b])&&c.push(a[b]);return c.join(" ")},_getRowSettings:function(a,c,d){var g={};d=d||"row";var e={};var k=b.Models.Registry.lookup(a.dataset.cid);
if(k){a=a.getElementsByClassName(d+"_inner")[0];e=a.children;d=0;for(var h=e.length;d<h;++d){var l=b.Models.Registry.lookup(e[d].dataset.cid);if(l){var n=e[d].getElementsByClassName("themify_module_holder");var t={};if(0<n.length){n=n[0].children;for(var m=0,w=n.length;m<w;++m){var u=b.Models.Registry.lookup(n[m].dataset.cid);if(u){var p=b.Utils.clear(u.get("mod_settings"),!0);t[m]={mod_name:u.get("mod_name")};0<Object.keys(p).length&&(t[m].mod_settings=p);-1!==n[m].className.indexOf("module_subrow")&&
(t[m]=this._getRowSettings(n[m],m,"subrow"))}}}g[d]={column_order:d,grid_class:this.filterClass(e[d].className)};0<Object.keys(t).length&&(g[d].modules=t);p=parseFloat(e[d].style.width);0<p&&!isNaN(p)&&(g[d].grid_width=p);p=b.Utils.clear(l.get("styling"),!0);0<Object.keys(p).length&&(g[d].styling=p)}}e={row_order:c,cols:g,column_alignment:k.get("column_alignment"),gutter:k.get("gutter")};g={gutter:"gutter-default",column_alignment:"col_align_top"};c={desktop_dir:"ltr",tablet_dir:"ltr",mobile_dir:"ltr",
col_tablet:"-auto",col_mobile:"-auto"};for(d in e)""!==e[d]&&e[d]!==g[d]||delete e[d];p=b.Utils.clear(k.get("styling"),!0);for(d in c)k=f.trim(a.getAttribute("data-"+d)),void 0!==k&&""!==k&&k!==c[d]&&(e[d]=k);0<Object.keys(p).length&&(e.styling=p)}return e},selectedGridMenu:function(a){for(var c,d,g,e,k=a.getElementsByClassName("grid_menu"),h=["mobile","tablet","desktop"],l=0,n=k.length;l<n;++l)if(a=f(k[l]),c=a.data("handle"),"module"!==c){d=a.closest(".module_"+c);g=b.Models.Registry.lookup(d.data("cid"));
var t=[];c=d.find("."+c+"_inner").first();var m=g.get("gutter"),w=g.get("column_alignment");e=g.get("desktop_dir");for(var u=g.get("styling"),p="",q={},x=c[0].children,r=0,z=x.length;r<z;++r)t.push(b.Utils._getColClass(x[r].className.split(" "))),x[r].className=x[r].className.replace(/first|last/ig,""),1!==z&&(0===r?x[r].className+="rtl"===e?" last":" first":r===z-1&&(x[r].className+="rtl"===e?" first":" last"));t=a.find(".themify_builder_grid_desktop .grid-layout-"+t.join("-"));r=t.data("col");0<
t.length&&(t.parent().addClass("selected").siblings().removeClass("selected"),d.addClass("col-count-"+r),p="col-count-"+r,q["data-basecol"]=r);"ltr"!==e&&(p+=" direction-rtl");for(r=0;3>r;++r)e=g.get(h[r]+"_dir"),"ltr"!==e&&""!==e&&(q["data-"+h[r]+"_dir"]=e,t=a.find(".themify_builder_grid_"+h[r]+" .column-dir-"+e),t.parent().addClass("selected").siblings().removeClass("selected")),"desktop"!==h[r]&&(e=g.get("col_"+h[r]),"-auto"!==e&&""!==e&&void 0!==e&&(q["data-col_"+h[r]]=e,t=a.find(".themify_builder_grid_"+
h[r]+" .grid-layout-"+e.replace(/column|tb_3col/ig,"")),t.parent().addClass("selected").siblings().removeClass("selected")));u&&void 0!==u.row_anchor&&""!==u.row_anchor&&d.find(".row-anchor-name").first().text(u.row_anchor);"col_align_top"!==w&&(a.find(".column-alignment-"+w).parent().addClass("selected").siblings().removeClass("selected"),p+=" "+w);"gutter-default"!==m&&(a.find(".gutter_select").val(m),p+=" "+m);c.addClass(p).attr(q)}},clear:function(a,c,b){b=b?[]:{};for(var d in a)if(Array.isArray(a[d])){var e=
this.clear(a[d],c,!0);0<e.length&&(b[d]=e)}else if("object"===typeof a[d])e=this.clear(a[d],c,!1),f.isEmptyObject(e)||(b[d]=e);else if(a[d]&&"px"!==a[d]&&"pixels"!==a[d]&&"solid"!==a[d]&&"linear"!==a[d]&&"default"!==a[d]&&"|"!==a[d]&&!(-1!==d.indexOf("_gradient-css")||"cover_gradient_hover-css"===d||"background_image-css"===d||"background_image-type_gradient"===d||d.indexOf("gradient-angle")&&"180"==a[d]||-1!==d.indexOf("_padding_apply_all_padding")||-1!==d.indexOf("_margin_apply_all_margin")||-1!==
d.indexOf("_border_apply_all_border")||"text_align_right"===d||"text_align_center"===d||"text_align_left"===d||"text_align_justify"===d||"show"===a[d]&&-1!==d.indexOf("visibility_"))){if(c&&("cover_gradient_hover-gradient"===d||"background_image-gradient"===d||-1===d.indexOf("gradient-angle")&&-1!==d.indexOf("_gradient-gradient"))&&(e=-1!==d.indexOf("background_gradient")?d.replace("_gradient","_type").replace("-gradient",""):d.replace("-gradient","-type").replace("_gradient","_color"),"gradient"!==
a[e]&&"cover_gradient"!==a[e]&&"hover_gradient"!==a[e])){e=["gradient-angle","type_image","circle-radial","gradient-type"];for(var k=d.replace("-gradient",""),h=0,l=e.length;h<l;++h){var n=k+"-"+e[h];void 0!==a[n]&&(a[n]=b[n]=null,delete a[n],delete b[n])}continue}b[d]=a[d]}return b},builderPlupload:function(a,c){var d=f(".themify-builder-plupload-upload-uic"+(c?"":"new_elemn"===a?".plupload-clone":""),top_iframe);if(0<d.length){var g=this;void 0===g.pconfig&&(g.pconfig=JSON.parse(JSON.stringify(themify_builder_plupload_init)),
g.pconfig.multipart_params._ajax_nonce=themifyBuilder.tb_load_nonce,g.pconfig.multipart_params.topost=themifyBuilder.post_ID);d.each(function(){var a=f(this),d=a.prop("id").replace("themify-builder-plupload-upload-ui",""),h=f.extend(!0,{},g.pconfig),l=["browse_button","container","drop_element","file_data_name"];h.multipart_params.imgid=d;for(var n=0,t=l.length;n<t;++n)h[l[n]]=d+g.pconfig[l[n]];a.data("extensions")?h.filters[0].extensions=a.data("extensions"):h.filters[0].extensions=null!==b.activeModel?
h.filters[0].extensions.replace(/\,zip|\,txt/,""):"zip,txt";d=new window.top.plupload.Uploader(h);d.init();d.bind("FilesAdded",function(a,c){a.refresh();a.start();ThemifyBuilderCommon.showLoader("show")});d.bind("Error",function(a,c){var b=f(".prompt-box .show-error");f(".prompt-box .show-login").hide();b.show();0<b.length&&b.html('<p class="prompt-error">'+c.message+"</p>");f(".overlay, .prompt-box").fadeIn(500)});d.bind("FileUploaded",function(d,e,g){var k=JSON.parse(g.response);d=f("#themify_builder_alert",
top_iframe);g="200"!==g.status||k.error?"error":"done";if(k.error)ThemifyBuilderCommon.showLoader(g),alert(k.error);else if(c){var h=f("#themify_builder_row_wrapper").children().clone(!0);d.promise().done(function(){b.Forms.reLoad(k,themifyBuilder.post_ID);var a=f("#themify_builder_row_wrapper").children().clone(!0);ThemifyBuilderCommon.Lightbox.close();b.vent.trigger("dom:change","","","","import",{before:h,after:a,bid:themifyBuilder.post_ID})})}else ThemifyBuilderCommon.showLoader(g),g=k.large_url?
k.large_url:k.url,a.closest(".themify_builder_input").find(".themify-builder-uploader-input").val(g).trigger("change").parent().find(".img-placeholder").html(f("<img/>",{src:k.thumb,width:50,height:50}))});a.removeClass("plupload-clone")})}},columnDrag:function(a,c,d,g){var e=this;c&&(c=a?a.children(".module_column"):f(".module_column"),c.css("width",""),e.setCompactMode(c));if(d&&g){a=a.children(".module_column");var k=("gutter-narrow"===d?1.6:"gutter-none"===d?0:3.2)-("gutter-narrow"===g?1.6:"gutter-none"===
g?0:3.2),k=parseFloat(k*(a.length-1)/a.length);a.each(function(a){f(this).prop("style").width&&(a=parseFloat(f(this).prop("style").width)+k,f(this).css("width",a+"%"))})}else{var h={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},n={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,
"col3-2":66.666};(a?a.children(".module_column").find(".themify_grid_drag"):f(".themify_grid_drag")).each(function(){var a,c,d,g,k=0,q,x=!1,r=0,z=!1,A,D,C,E;f(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,snap:!1,containment:".row_inner",helper:function(b){a=f(b.currentTarget);c=a.closest(".subrow_inner");0===c.length&&(c=a.closest(".row_inner"));q=a.hasClass("themify_drag_right")?"w":"e";A="w"===q?"themify_grid_drag_placeholder_right":"themify_grid_drag_placeholder_left";z=ThemifyBuilderCommon.Lightbox.clone(c.closest(".module_row"));
return f('<div class="ui-widget-header themify_grid_drag_placeholder '+A+'"></div><div class="ui-widget-header themify_grid_drag_placeholder"></div>')},start:function(b,e){d=c.children(".module_column");g=a.closest(".module_column");C=c.hasClass("direction-rtl");"w"===q?(x=C?g.prev(".module_column"):g.next(".module_column"),k=a.outerWidth()):(x=C?g.next(".module_column"):g.prev(".module_column"),k=g.outerWidth());r=x.outerWidth()-2;E=e.position.left;D=c.outerWidth()},stop:function(a,k){f(".themify_grid_drag_placeholder").remove();
var m=Math.ceil(100*(g.outerWidth()/D));g.css("width",m+"%");var p=h,m=3.2;c.hasClass("gutter-narrow")?(p=l,m=1.6):c.hasClass("gutter-none")&&(p=n,m=0);var t=m*(d.length-1);d.each(function(a){a!==x.index()&&(f(this).prop("style").width?a=parseFloat(f(this).prop("style").width):(a=f.trim(e.filterClass(f(this).attr("class")).replace("first","").replace("last","")),a=p[a]),t+=a)});x.css("width",100-t+"%");x=x.add(g);e.setCompactMode(x);m=c.closest(".module_row");b.vent.trigger("dom:change",m.data("cid"),
z,m,"row")},drag:function(a,c){if(x&&0<x.length){var b=k+("e"===q?-c.position.left:c.position.left),d=parseFloat(100*b/D);if(5<=d&&100>d){var f=r+E+("w"===q?-c.position.left:c.position.left),h=parseFloat(100*f/D);5<h&&100>h&&(x.css("width",f+"px"),g.css("width",b+"px").children("."+A).html(d.toFixed(2)+"%"),g.children(".themify_grid_drag_placeholder").last().html(h.toFixed(2)+"%"),e.setCompactMode(g))}}}})})}},setCompactMode:function(a){a instanceof jQuery&&(a=a.get());for(var c=0,b=a.length;c<b;++c){var f=
a[c].clientWidth,f=234>f?["compact-mode-action","compact-mode"]:370>f?["compact-mode"]:"";a[c].classList.remove("compact-mode-action");a[c].classList.remove("compact-mode");if(""!==f)for(var e in f)a[c].classList.add(f[e]);if(""===f||"compact-mode"===f[0])f=a[c].getElementsByClassName("sub_column"),0<f.length&&this.setCompactMode(f)}},initNewEditor:function(a){var c=tinyMCEPreInit.mceInit.tb_lb_hidden_editor;c.elements=a;c.selector="#"+a;return this.initMCEv4(a,c)},initMCEv4:function(a,c){if(3<parseInt(tinyMCE.majorVersion)){var b=
new tinyMCE.Editor(a,c,tinyMCE.EditorManager);b.render();return b}},initQuickTags:function(a){"function"===typeof window.parent.QTags&&(window.parent.quicktags({id:a}),window.parent.QTags._buttonsInit())},setColorPicker:function(a){f(".minicolors-swatch",a).each(function(){var a=f(this),d=a.closest(".minicolors_wrapper");f(this).one("click",function(){var a=d.find(".minicolors-input");d.prepend(a).find(".minicolors").remove();b.Views.init_control("color",{el:a,binding_type:a.data("control-binding")})}).prev(".minicolors-input").one("focusin",
function(){f(this).next(".minicolors-swatch").trigger("click")});d.find(".color_opacity").one("change",function(){a.prev(".minicolors-input").attr("data-opacity",f(this).val());a.trigger("click")})})},_getColClass:function(a){for(var c=0,b=a.length;c<b;++c)if(-1!==this.gridClass.indexOf(a[c]))return a[c].replace("col","")},saveBuilder:function(a,c,d,g){c=c||"main";d=d||0;0===d&&("main"===c&&b.activeModel&&f(".builder_save_button",top_iframe).trigger("click"),ThemifyBuilderCommon.showLoader("show"));
var e=Object.keys(b.Instances.Builder).length,k=b.Instances.Builder[d],h=this,l=k.$el.data("postid"),k=k.toJSON();(function(a,c,d,e){c={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,data:JSON.stringify(c),tb_saveto:d,sourceEditor:"visual"===b.mode?"frontend":"backend"};e&&(c.only_data=e);return f.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:c})})(l,k,c,g).always(function(g,k){++d;e===d?(f.isFunction(a)&&a.call(h,g,k),"success"!==k?ThemifyBuilderCommon.showLoader("error"):
(ThemifyBuilderCommon.showLoader("hide"),b.editing=!0,f("body").trigger("themify_builder_save_data",[g,k]))):setTimeout(function(){h.saveBuilder(a,c,d)},50)})},loadContentJs:function(a,c){ThemifyBuilderModuleJs.loadOnAjax(a,c);if(!1===b.saving){var d=f(".wp-audio-shortcode, .wp-video-shortcode",a).not(".mejs-container").filter(function(){return!f(this).parent().hasClass("mejs-mediaelement")});if(0<d.length){if(themifyBuilder.media_css){for(var g in themifyBuilder.media_css)Themify.LoadCss(themifyBuilder.media_css[g]);
themifyBuilder.media_css=null}d.mediaelementplayer("undefined"!==typeof window.top._wpmejsSettings?window.top._wpmejsSettings:{})}}f("body").trigger("builder_load_module_partial",[a,c])},mediaUploader:function(){var a={};f("body",top_iframe).on("click",".themify-builder-media-uploader",function(c){c.preventDefault();c.stopPropagation();var b=f(this),g=b.closest(".themify_builder_input");c=b.data("uploader-title");var e=b.data("uploader-button-text"),b=b.data("library-type")?b.data("library-type"):
"image",k=Themify.hash(b+c+e);if(void 0!==a[k])var h=a[k];else h=wp.media.frames.file_frame=wp.media({title:c,library:{type:b},button:{text:e},multiple:!1}),a[k]=h;h.off("select").on("select",function(){var a=h.state().get("selection").first().toJSON();g.find(".themify-builder-uploader-input").val(a.url).trigger("change").parent().find(".img-placeholder").html(f("<img/>",{src:a.url,width:50,height:50}));g.find(".themify-builder-uploader-input-attach-id").val(a.id)});h.open()}).on("click",".themify-builder-delete-thumb",
function(a){a.preventDefault();f(this).prev().empty().closest(".themify_builder_input").find(".themify-builder-uploader-input").val("").trigger("change")}).on("click",".insert-media",function(a){window.top.wpActiveEditor=f(this).data("editor")})},openGallery:function(){var a=wp.media.gallery.shortcode,c=this,b=null;f("body",top_iframe).on("click",".tb-gallery-btn",function(d){d.preventDefault();var e=f(this).closest(".themify_builder_input").find(".tb-shortcode-input");null===b&&(b=wp.media.frames.file_frame=
wp.media({frame:"post",state:"gallery-edit",title:wp.media.view.l10n.editGalleryTitle,editing:!0,multiple:!0,selection:!1}),b.$el.addClass("themify_gallery_settings"));wp.media.gallery.shortcode=function(c){var b=c.props.toJSON(),d=_.pick(b,"orderby","order");c.gallery&&_.extend(d,c.gallery.toJSON());d.ids=c.pluck("id");b.uploadedTo&&(d.id=b.uploadedTo);d._orderbyRandom&&(d.orderby="rand",delete d._orderbyRandom);d.ids&&"post__in"===d.orderby&&delete d.orderby;_.each(wp.media.gallery.defaults,function(a,
c){a===d[c]&&delete d[c]});c=new window.top.wp.shortcode({tag:"gallery",attrs:d,type:"single"});e.val(c.string()).trigger("change");wp.media.gallery.shortcode=a;return c};b.on("update",function(a){var b=wp.media.gallery.shortcode(a).string().slice(1,-1);e.val("["+b+"]");c.setShortcodePreview(a.models,e)});0<f.trim(e.val()).length?(b=wp.media.gallery.edit(f.trim(e.val())),b.state("gallery-edit").on("update",function(a){var b=wp.media.gallery.shortcode(a).string().slice(1,-1);e.val("["+b+"]");c.setShortcodePreview(a.models,
e)})):(b.open(),b.$el.find(".media-menu .media-menu-item").last().trigger("click"))})},setShortcodePreview:function(a,c){var b=c.next(".tb_shortcode_preview"),g="";0===b.length&&(b=f('<div class="tb_shortcode_preview"></div>'),c.after(b));for(var e=0,k=a.length;e<k;++e)var h=a[e].attributes,g=g+('<img src="'+(h.sizes.thumbnail?h.sizes.thumbnail.url:h.url)+'" width="50" height="50" />');b[0].innerHTML=g},createGradientPicker:function(a,c,d){var g=a.closest(".themify-gradient-field"),e=null,k=!1,h=
a.data("id"),l=g.find("#"+h+"-gradient-angle"),n=a.prev(),t={angle:l.val(),onChange:function(c,d){k&&(c=d="");"visual"===b.mode&&("cover_gradient"===h||"cover_gradient_hover"===h?b.liveStylingInstance.addOrRemoveComponentOverlay(h,d):b.liveStylingInstance.bindBackgroundGradient(h,d));a.val(c)},onInit:function(){n.show()}};t.gradient=c?c:a.data("default-gradient")?a.data("default-gradient"):void 0;d||n.ThemifyGradient(t);e=a.prev().data("themifyGradient");c=g.find("#"+h+"-gradient-type");var m=g.find("#"+
h+"-circle-radial input"),q=function(a){var c=l.parent(".gradient-angle-knob"),b=g.find("#"+h+"-circle-radial");"radial"===a?(c.hide(),c.next("span").hide(),b.show()):(c.show(),c.next("span").show(),b.hide())};d?(e.settings=f.extend({},e.settings,t),e.settings.type=c.val(),e.settings.circle=m.is(":checked"),e.isInit=!1,e.update(),e.isInit=!0):(g.find(".themify-clear-gradient").on("click",function(a){a.preventDefault();k=!0;e.settings.gradient=f.ThemifyGradient["default"];e.update();k=!1}),c.on("change",
function(a){e.setType(f(this).val());q(f(this).val())}),m.on("change",function(){e.setRadialCircle(f(this).is(":checked"))}),l.on("change",function(){var a=parseInt(f(this).val());a||(a=0);e.setAngle(a)}).knob({change:function(a){e.setAngle(Math.round(a))}}),l.removeAttr("style").parent().addClass("gradient-angle-knob").find("canvas").insertAfter(l));q(c.val())},toRGBA:function(a){var c=a.split("_"),b=/^([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/;return void 0!==c[0]?(b=b.exec(c[0].replace("#",
"")),c=void 0!==c[1]&&"0.99"!=c[1]?c[1]:1,b?"rgba("+parseInt(b[1],16)+", "+parseInt(b[2],16)+", "+parseInt(b[3],16)+", "+c+")":a):a},getBPWidth:function(a){a=_.isArray(themifyBuilder.breakpoints[a])?themifyBuilder.breakpoints[a]:themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-1]},transitionPrefix:function(){if(void 0===this.transitionPrefix.pre){var a=document.createElement("fakeelement"),c={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",
WebkitTransition:"webkitTransitionEnd"},b;for(b in c)if(void 0!==a.style[b]){this.transitionPrefix.pre=c[b];break}}return this.transitionPrefix.pre}};_.extend(b.Views.BaseElement.prototype,b.Mixins.Common);_.extend(b.Views.Builder.prototype,b.Mixins.Builder);b.Views.ControlRegistry={items:{},register:function(a,c){this.items[a]=c},lookup:function(a){return this.items[a]||null},remove:function(a){delete this.items[a]},destroy:function(){_.each(this.items,function(a,c){a.remove()});this.items={}}};
b.Views.Controls["default"]=Backbone.View.extend({initialize:function(a){b.Views.ControlRegistry.register(this.$el.prop("id"),this);a.binding_type&&(this.binding_type=a.binding_type)},preview_element:function(a){if(void 0!==this.binding_type){var c=this.$el.data("control-type"),d="repeater"===c?this.$el.prop("id"):this.$el.data("control-repeater");d&&"visual"===b.mode?(a=f("#"+d,top_iframe),0<a.length&&(q[d]=b.Forms.parseSettings(a[0]).v)):q[this.$el.prop("id")]=a;"visual"===b.mode?"live"===this.binding_type?
b.activeModel.trigger("custom:preview:live",q,"wp_editor"===c||"TEXTAREA"===this.el.tagName):"refresh"===this.binding_type&&b.activeModel.trigger("custom:preview:refresh",q):b.activeModel.backendLivePreview()}}});b.Views.Controls["default"].extend=function(a){var c=this,b=Backbone.View.extend.apply(this,arguments);b.prototype.events=_.extend({},this.prototype.events,a.events);b.prototype.initialize=function(){_.isFunction(c.prototype.initialize)&&c.prototype.initialize.apply(this,arguments);_.isFunction(a.initialize)&&
a.initialize.apply(this,arguments)};return b};b.Views.register_control=function(a,b){"default"!==a&&(this.Controls[a]=this.Controls["default"].extend(b))};b.Views.get_control=function(a){return this.control_exists(a)?this.Controls[a]:this.Controls["default"]};b.Views.control_exists=function(a){return this.Controls.hasOwnProperty(a)};b.Views.init_control=function(a,c){c=c||{};"wp_editor"===a&&(c.el.hasClass("data_control_binding_live")?c.binding_type="live":c.el.hasClass("data_control_binding_refresh")&&
(c.binding_type="refresh"));var d=c.el.data("input-id")?c.el.data("input-id"):c.el.prop("id"),d=this.ControlRegistry.lookup(d);return null!==d?(d.setElement(c.el).render(),d):new (b.Views.get_control(a))(c)};b.Views.register_control("wp_editor",{initialize:function(){this.render()},render:function(){var a=this,c="refresh"===this.binding_type?1E3:50,d=this.$el.prop("id"),g="",c=_.throttle(function(c){c="setupeditor"===this.type?this.getContent():f(this).val();null!==b.activeModel&&g!==c&&(g=c,!1!==
e?a.$el.val(c).trigger("change"):a.preview_element(c))},c);b.Utils.initQuickTags(d);if(void 0!==tinyMCE&&void 0!==this.binding_type){d=b.Utils.initNewEditor(d);var e=this.$el.hasClass("wp-editor-area")?0<this.$el.closest("#instance_widget").length:!1;d.on("change keyup",c)}this.$el.on("change keyup",c);return this}});b.Views.register_control("change",{initialize:function(){this.render()},render:function(){var a=this,c="refresh"===this.binding_type?1E3:50,b=this.$el.data("control-event");if(void 0===
b||""===b)b="change",c=1;this.$el.on(b,_.throttle(function(){a.preview_element(this.value)},c));return this}});b.Views.register_control("query_category",{initialize:function(){this.render()},render:function(){var a=this,b=a.$el.parent(),d=b.find(".query_category_single"),f=b.find(".query_category_multiple");d.add(f).on("change",function(b){b=f.val()?f.val()+"|multiple":d.val()+"|single";a.preview_element(b)});return this}});b.Views.register_control("layout",{initialize:function(){this.render()},render:function(){var a=
this,c=this.$el.data("input-id")?this.$el.data("input-id"):this.$el.prop("id"),d=a.$(".tfl-icon.selected").prop("id");this.$(".tfl-icon").on("click",function(g){g.preventDefault();f(this).addClass("selected").siblings().removeClass("selected");if("visual"===b.mode)if(g=f(this).prop("id"),"live"===a.binding_type&&void 0!==a.$el.data("control-selector")){var e=b.liveStylingInstance.$liveStyledElmt;""!==a.$el.data("control-selector")&&(e=b.liveStylingInstance.$liveStyledElmt.find(a.$el.data("control-selector")));
var k=b.liveStylingInstance.getStylingVal(c);q[c]=g;"layout_feature"===c?(g="layout-"+g,k="layout-"+k):"columns"===c&&(g=c+"-"+g,k=c+"-"+k);!k&&d&&(k=d);e.removeClass(k).addClass(g);"layout_feature"===c?g=g.substr(7):"columns"===c&&(g=g.substr(8));b.liveStylingInstance.setStylingVal(c,g)}else a.preview_element(g)});return this}});b.Views.register_control("radio",{initialize:function(){this.render()},render:function(){var a=this;this.$('input[type="radio"]').on("change",function(){a.preview_element(this.value)});
return this}});b.Views.register_control("checkbox",{initialize:function(){this.render()},render:function(){var a=this;this.$('input[type="checkbox"]').on("click",function(){if(!_.isUndefined(a.binding_type)){var b=a.$('input[type="checkbox"]:checked').map(function(){return this.value}).get();a.preview_element(b.join("|"))}});return this}});b.Views.register_control("color",{is_typing:!1,initialize:function(){this.render()},render:function(){var a=this,c=this.$el.next(".color_opacity"),d=this.$el.prop("id");
this.$el.minicolors({opacity:1,changeDelay:200,beforeShow:function(){var b=ThemifyBuilderCommon.Lightbox.$lightbox,c=a.$el.closest(".minicolors"),d=c.find(".minicolors-panel");d.css("visibility","hidden").show();b.offset().left+b.width()<=d.offset().left+d.width()?c.addClass("tb-minicolors-right"):c.removeClass("tb-minicolors-right");d.css("visibility","").hide()},change:function(g,e){if(!g||e&&"0.99"==e)e=1;a.is_typing||c.is(":focus")||c.attr("data-opacity",e).data("opacity",e).val(e);var k=g?f(this).minicolors("rgbaString"):
"";void 0!==a.binding_type?a.preview_element(k):"visual"===b.mode&&f("body").trigger("themify_builder_color_picker_change",[d,a.$el,g?k:""])}}).minicolors("show");c.on("blur keyup",function(b){var c=parseFloat(f.trim(f(this).val()));if(1<c||isNaN(c)||""===c||0>c)c=a.$el.val()?1:"","blur"===b.type&&f(this).val(c);f(this).attr("data-opacity",c);a.is_typing="keyup"===b.type;a.$el.minicolors("opacity",c)})}});b.Views.register_control("repeater",{events:{"click .toggle_row":"toggleField","click .themify_builder_duplicate_row":"duplicateRowField",
"click .themify_builder_delete_row":"deleteRowField"},initialize:function(){this.render()},render:function(){var a=this.$el,b=this,d=!1;a.sortable({items:".tb_repeatable_field",handle:".tb_repeatable_field_top",axis:"y",placeholder:"themify_builder_ui_state_highlight",tolerance:"pointer",cursor:"move",start:_.debounce(function(b,c){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=f(this).prop("id"),b=tinymce.get(a).getContent();f(this).data("content",b);tinyMCE.execCommand("mceRemoveEditor",
!1,a)})},300),stop:_.debounce(function(c,e){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=f(this).prop("id");tinyMCE.execCommand("mceAddEditor",!1,a);tinymce.get(a).setContent(f(this).data("content"))});d&&(e.item.removeClass("collapsed").find(".tb_repeatable_field_content").show(),d=!1);a.find(".themify_builder_ui_state_highlight").remove();b.preview_element()},300),sort:function(b,c){a.find(".themify_builder_ui_state_highlight").height(30)},beforeStart:function(b,c){c.item.hasClass("collapsed")||
(c.item.addClass("collapsed").find(".tb_repeatable_field_content").hide(),d=!0,a.sortable("refresh"))}});return this},toggleField:function(a){a.preventDefault();f(a.currentTarget).closest(".tb_repeatable_field").toggleClass("collapsed").find(".tb_repeatable_field_content").slideToggle()},duplicateRowField:function(a){a.preventDefault();a.stopPropagation();this.$el.next(".add_new").find("a").trigger("click",f(a.currentTarget).closest(".tb_repeatable_field"));this.preview_element()},deleteRowField:function(a){a.preventDefault();
a.stopPropagation();confirm(themifyBuilder.i18n.rowDeleteConfirm)&&(f(a.currentTarget).closest(".tb_repeatable_field").remove(),this.preview_element())}});b.Views.register_control("widget_form",{initialize:function(){this.render()},render:function(){this.$el.on("change",":input",this._updateWidgetPreview.bind(this));return this},_updateWidgetPreview:function(){this.preview_element(this.$el.find(":input").themifySerializeObject())}})})(jQuery);
